...
Trong chương này, chúng ta xác định các ca sử dụng (use cases) trong hệ thống, đặc tả một số ca sử dụng quan trọng để hoàn tất thiết kế usecase.
...
\begin{longtable}{|c|p{3cm}|p{10cm}|}
	...
	\hline
 AC03        & Hệ thống thanh toán            & Hệ thống xử lý các giao dịch thanh toán, kết nối với các phương thức thanh toán điện tử và in hóa đơn.                                                                     \\
	\hline
...
\begin{longtable}{|c|p{3cm}|p{6cm}|p{3.5cm}|}
	...
	\hline
 UC11        & Quản lý công thức       & CRUD công thức chế biến cho các sản phẩm.                                                & Quản lý                             \\
	\hline
 UC12        & Quản lý combo           & CRUD các gói combo sản phẩm.                                                                 & Quản lý                             \\
	\hline
 UC13        & Quản lý danh mục hàng   & CRUD danh mục sản phẩm (trong kho, sản phẩm bán), thông tin hàng hóa, giá bán.                 & Quản lý                             \\
	\hline
 UC14        & Quản lý khuyến mại      & CRUD các chương trình khuyến mại, giảm giá.                                             & Quản lý                             \\
	\hline
 UC15        & Quản lý nhân viên       & CRUD nhân viên, phân quyền truy cập và quản lý giờ làm                                        & Quản lý                             \\
	\hline
...
Phần này trình bày đặc tả chi tiết cho các ca sử dụng quan trọng của hệ thống.
...
\begin{enumerate}
 ...
 \item \textbf{Hệ thống}: So sánh tiền thực tế và tiền dự kiến. Hiển thị chênh lệch (thừa/thiếu) nếu có.
...
\noindent \textbf{Luồng sự kiện chính:}
\begin{enumerate}
 \item \textbf{Nhân viên}: Chọn chức năng "Lịch làm việc" từ menu.
	\item \textbf{Nhân viên}: Chọn chức năng "Xin nghỉ".
...
\begin{enumerate}
 \item \textbf{Nhân viên}: Chọn chức năng "Lịch làm việc" từ menu.
	\item \textbf{Hệ thống}: Hiển thị lịch làm việc tuần/tháng.
	\item \textbf{Nhân viên}: Chọn chức năng "Đăng kí ca làm".
	\item \textbf{Hệ thống}: Hiển thị lịch tuần/tháng với các ca làm việc khả dụng.
 \item \textbf{Nhân viên}: Chọn ngày làm, giờ làm muốn đăng kí.
...
\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC01_DangNhap.png}
  \caption{Quy trình Đăng nhập}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC04_BanHang.png}
  \caption{Quy trình Bán hàng}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC08_NhapHang.png}
  \caption{Quy trình Nhập hàng}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC10_QuanLyCaLamViec.png}
  \caption{Quy trình Quản lý ca làm việc}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC05_CheBienThucPham.png}
  \caption{Quy trình Chế biến thực phẩm}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC06_LamLaiDonHang.png}
  \caption{Quy trình Làm lại đơn hàng}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC07_TieuHuy.png}
  \caption{Quy trình Tiêu huỷ}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC09_KiemKeTonKho.png}
  \caption{Quy trình Kiểm kê tồn kho}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC18_ChamCong.png}
  \caption{Quy trình Chấm công}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC20_XinNghi.png}
  \caption{Quy trình Xin nghỉ}
\end{figure}

\begin{figure}[H]
  \includegraphics[width=\textwidth]{assets/diagram_operation/UC21_DangKyLichLamViec.png}
  \caption{Quy trình Đăng ký lịch làm việc}
\end{figure}

\section{Yêu cầu phi chức năng}
- Các tính toán liên quan đến nghiệp vụ cần chính xác tuyệt đối
- Thời gian khởi động app < 3s
- Thiết kế giao diện trên máy POS tối ưu cho thao tác cảm ứng
