...
\begin{landscape}
  \begin{figure}[p]
    \centering
  \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{assets/diagram_class/Conceptual_Class_Diagram.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=0.9\textwidth]{assets/diagram_class/ACD_Domain_UserAuth.png}
 \caption{Mô hình khái niệm - Xác thực và phân quyền}
\end{figure}

\begin{figure}[H]
  \centering
 \includegraphics[width=0.9\textwidth]{assets/diagram_class/ACD_Domain_Catalog.png}
 \caption{Mô hình khái niệm - Quản lý danh mục}
 \end{figure}
 
 \begin{figure}[H]
 \centering
 \includegraphics[width=0.9\textwidth]{assets/diagram_class/ACD_Domain_Inventory.png}
 \caption{Mô hình khái niệm - Quản lý kho}
\end{figure}

\begin{figure}[H]
  \centering
 \includegraphics[width=0.9\textwidth]{assets/diagram_class/ACD_Domain_Sales.png}
 \caption{Mô hình khái niệm - Bán hàng và thanh toán}
\end{figure}

\begin{figure}[H]
  \centering
 \includegraphics[width=0.9\textwidth]{assets/diagram_class/ACD_Domain_Promotion.png}
 \caption{Mô hình khái niệm - Quản lý khuyến mãi}
\end{figure}

\begin{figure}[H]
  \centering
 \includegraphics[width=0.9\textwidth]{assets/diagram_class/ACD_Domain_ShiftMgmt.png}
 \caption{Mô hình khái niệm - Quản lý ca làm việc}
\end{figure}

\begin{figure}[H]
  \centering
 \includegraphics[width=0.9\textwidth]{assets/diagram_class/ACD_Domain_StoreConfig.png}
 \caption{Mô hình khái niệm - Cấu hình cửa hàng}
 \end{figure}
 
 \begin{landscape}
 \begin{figure}[p]
   \centering
   \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{assets/diagram_class/ACD_Domain_Workforce.png}
